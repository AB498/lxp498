...
<template>
    <div class=" flex flex-col w-full relative hover:-translate-y-1 shadow-md transition h-full rounded-xl">
        ...
        <div class="p-4 w-full overflow-auto">
            <div class="w-full overflow-ellipsis text-xs line-clamp-3 " v-text="video.title || 'No Title'"></div>
            <div class="w-full overflow-ellipsis text-xs themed-text-secondary line-clamp-2 break-words" v-text="video.description || 'No Description'">
            </div>
        </div>
    </div>
</template>