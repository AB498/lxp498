            ...
            try {
                ...
                if (p == '/openYTVideo/id') {
                    ...
                    if (!vid) {
                        ...
                        vid = (await models.Video.create({ id: v, title: vidInfo.data.items[0].snippet.title, description: vidInfo.data.items[0].snippet.description, thumbnailUrl: vidInfo.data.items[0].snippet.thumbnails.default.url })).dataValues;
                    }
