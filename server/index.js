...
global.glb.apiEndpoints = [
    ...
    { method: 'POST', url: '/api/updateSelf', middlewares: { main: [global.glb.authMiddleware], test: [], both: [userController.updateSelf] } },
    ...
    { method: 'POST', url: '/api/getMostVotedLanguage/:id', middlewares: { main: [], test: [], both: [videoController.getMostVotedLanguage] } },
    { method: 'POST', url: '/api/listVotes/:id', middlewares: { main: [], test: [], both: [videoController.listVotes] } },
    ...
    { method: 'POST', url: '/api/uploadbase/voteVideoLanguage/:id', middlewares: { main: [global.glb.authMiddleware], test: [], both: [ubController.voteVideoLanguage] } },
    { method: 'POST', url: '/api/uploadbase/getMostVotedLanguage/:id', middlewares: { main: [], test: [], both: [ubController.getMostVotedLanguage] } },
    { method: 'POST', url: '/api/uploadbase/listVotes/:id', middlewares: { main: [], test: [], both: [ubController.listVotes] } },
